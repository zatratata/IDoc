//
//  RectangleImageTitleTextCell.swift
//  iDoc
//
...
final class RectangleImageTitleTextCell: UITableViewCell {
    
    private let borderWidth: CGFloat = 1

    static let cellID = "RectangleImageTitleTextCell"
    ...
    //MARK: - Methods
    func setupCell(with consultation: ConsultationCategories) {
